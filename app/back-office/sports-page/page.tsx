                ...
                <div className="card-body">
                  ...
                  <div className="row mb-2">
                    ...
                    <div className="col-6 text-end">
                      <button className="btn btn-blue" onClick={saveall_news}>
                        SAVE
                      </button>
                    </div>
                  </div>
